          ...
          <Offcanvas.Body>
            ...
            <nav>
              <ul> {/*Um menu para colocar todos os links do menu lateral */}
                ...
                <li className='item'><Link to="/Doacao">Contribuição</Link></li>
            ...
            <div className='redes'>
              <ul className='redes-link'>
                <div className='iconess'>
                  <a href="https://www.instagram.com/opus_task/"><img href="https://www.instagram.com/opus_task/" src={instagramIcon} alt="insta" className='insta' /></a>
                  <a href="https://www.facebook.com/?locale=pt_BR"><img href="https://www.uol.com.br/tilt/facebook/" src={facebookIcon} alt="face" className='face' /></a>
                  <a href="https://www.whatsapp.com/?lang=pt_BR"><img href="https://web.whatsapp.com/" src={whatsappIcon} alt="whats" className='whats' /></a>
                </div>
              </ul>
            </div>
          </Offcanvas.Body>
